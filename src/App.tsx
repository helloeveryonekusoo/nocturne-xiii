...
import {
  ...
  resolvePendingEffect, selectScholarCard, type Card, type GameState, type PlayerView,
...
export default function App() {
  ...
  const goHome = () => {
    ...
    setScreen('home'); setGame(null); setOnlineView(null); setLobby(null); setRoomCode(''); setTargeting(null);
  };
